...
<html>
	<head>
		...
		<link rel="stylesheet" href="./resources/css/add-cat.css"/>
		<style type="text/css">
		* {
			margin: 0;
			border: 0;
	...
	<body>
		<header>
			...
			<nav>
				...
				<ul>
					<li><a href="Add-Category.html" class="current">Add Category</a></li>
			...
			<div id="User">		
			<h2>Add a New Category</h2><br><br>
...
<tr>
    ...
    <td><form:input path="categoryName" id="last" placeholder="Category Name" pattern="[a-zA-Z]{1,100}$" required="required" maxlength="20" autocomplete="Off" onMouseDown="active();" onblur="inactive();"/> <font color="red"><form:errors path="categoryName"/></font></td>
</tr>

<tr>
    <th colspan="2"><input type="submit" id="btn1" value="Add Category!"/></th>
