    ...
    <body>
        <header>
            ...
            <nav>
                ...
                <ul>
                    <li><a href="#" class="current">Add Category</a></li>
            ...
            <div id="User">        
            <h1> Category Added Successfully:- ${category.categoryName} </h1><br><br>
            
            <a href="addcategory.htm" target="contents"/><h2>Add Another Category</h2><br><br>
